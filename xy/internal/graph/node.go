...
var _ Component = &Node{}

func (n *Node) FirstCoord() geom.Coord {
	return n.coord
}
...
func (n *Node) computeMergedLocation(label2 *Label, eltIndex int) location.Type {
	loc := location.None
	loc = n.label[eltIndex][OnLabel]
	if !label2[eltIndex].isNull() {
		nLoc := label2[eltIndex][OnLabel]
